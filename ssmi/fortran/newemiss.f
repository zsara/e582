...
*
*----------------------------------------------------------------------
      subroutine emiss(ifreq,u,sst,theta,emissh,emissv)
*
*   INPUT:
*
*   ifreq = 1 (19.35)        u     = wind speed (m/s)
...
*  
      real ebiasv(4),ebiash(4),cf(4),cg(4),emissv,emissh
      real theta,sst,u,fem,foam
      integer ifreq
